...
func setupRocksDB(parser bchain.BlockChainParser, chain bchain.BlockChain, t *testing.T, spendingIndex bool, config *common.Config) (*db.RocksDB, *common.InternalState, string) {
...
func setupPublicHTTPServer(parser bchain.BlockChainParser, chain bchain.BlockChain, t *testing.T, spendingIndex bool) (*PublicServer, string) {
	...
	d, is, path := setupRocksDB(parser, chain, t, spendingIndex, &config)
...
func httpTestsBitcoinSpendingIndex(t *testing.T, ts *httptest.Server) {
	tests := []struct {
		name        string
		r           *http.Request
		status      int
...
func Test_PublicServer_BitcoinType_SpendingIndex(t *testing.T) {
	...
	httpTestsBitcoinSpendingIndex(t, ts)
